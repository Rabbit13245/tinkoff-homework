...
class FakeDataGenerator{
    let conversations = [
        [
            ...
            ConversationCellModel(name: "Donald Trump", message: "Voluptate irure aliquip consectetur commodo ex ex.", date: Date().addingTimeInterval(-60*60), isOnline: true, hasUnreadMessages: false),
            ...
            ConversationCellModel(name: "Angela Merkel", message: "", date: Date().addingTimeInterval(-86400), isOnline: true, hasUnreadMessages: false),
            ConversationCellModel(name: "Elon Musk", message: "", date: Date().addingTimeInterval(-86400*2), isOnline: true, hasUnreadMessages: false),
        ...
        [
            ...
            ConversationCellModel(name: "Oleg Tinkov", message: "Reprehenderit mollit excepteur labore deserunt officia laboris eiusmod cillum eu duis", date: Date().addingTimeInterval(-60*10), isOnline: false, hasUnreadMessages: false),
            ConversationCellModel(name: "Vladimir Putin", message: "Aliqua mollit nisi incididunt id eu consequat eu cupidatat.", date: Date().addingTimeInterval(-60*15), isOnline: false, hasUnreadMessages: false),
            ...
            ConversationCellModel(name: "Boris Yeltsin", message: "", date: Date().addingTimeInterval(-60*60*2), isOnline: false, hasUnreadMessages: false),
            ConversationCellModel(name: "Mikhail Gorbachev", message: "", date: Date().addingTimeInterval(-86400), isOnline: false, hasUnreadMessages: false),
            ConversationCellModel(name: "Yevgeny Kaspersky", message: "", date: Date().addingTimeInterval(-86400*2), isOnline: false, hasUnreadMessages: false),
            ConversationCellModel(name: "David Yang", message: "", date: Date().addingTimeInterval(-86400*3), isOnline: false, hasUnreadMessages: false),
            ConversationCellModel(name: "Andrey Akinshin", message: "", date: Date().addingTimeInterval(-86400*3), isOnline: false, hasUnreadMessages: false),
        ],
    ]
